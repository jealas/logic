...
constexpr logic::bits<1> xor_function(logic::bits<2> bits) {
    return bits.bit<0>() xor bits.bit<1>();
}

constexpr logic::bits<1> nand_function(logic::bits<2> bits) {
    return not (bits.bit<0>() and bits.bit<1>());
}

constexpr logic::bits<1> nor_function(logic::bits<2> bits) {
    return not (bits.bit<0>() or bits.bit<1>());
}

constexpr logic::bits<1> xnor_function(logic::bits<2> bits) {
    return not (bits.bit<0>() xor bits.bit<1>());
}

constexpr logic::bits<1> not_function(logic::bits<1> bit) {
    return not bit.value();
}

TEST_CASE("Can compile simple logic gates", "[logic][compile]") {
    SECTION("and function") {
        static constexpr auto compiled_and_function = logic::compile<logic::default_storage>(&and_function);
    ...
    SECTION("or function") {
        static constexpr auto compiled_or_function = logic::compile<logic::default_storage>(&or_function);
    ...
    SECTION("xor function") {
        static constexpr auto compiled_xor_function = logic::compile<logic::default_storage>(&xor_function);
    ...
    SECTION("nand function") {
        static constexpr auto compiled_nand_function = logic::compile<logic::default_storage>(&nand_function);
    ...
    SECTION("nor function") {
        static constexpr auto compiled_nor_function = logic::compile<logic::default_storage>(&nor_function);
    ...
    SECTION("xnor function") {
        static constexpr auto compiled_xnor_function = logic::compile<logic::default_storage>(&xnor_function);
    ...
    SECTION("not function") {
        static constexpr auto compiled_not_function = logic::compile<logic::default_storage>(&not_function);
...
TEST_CASE("Can compile simple logic gates with multiple input bits", "[logic][compile]") {
    SECTION("and function") {
        static constexpr auto compiled_and_function = logic::compile<logic::default_storage>(&and_function_multi);
    ...
    SECTION("or function") {
        static constexpr auto compiled_or_function = logic::compile<logic::default_storage>(&or_function_multi);
    ...
    SECTION("xor function") {
        static constexpr auto compiled_xor_function = logic::compile<logic::default_storage>(&xor_function_multi);
    ...
    SECTION("nand function") {
        static constexpr auto compiled_nand_function = logic::compile<logic::default_storage>(&nand_function_multi);
    ...
    SECTION("nor function") {
        static constexpr auto compiled_nor_function = logic::compile<logic::default_storage>(&nor_function_multi);
    ...
    SECTION("xnor function") {
        static constexpr auto compiled_xnor_function = logic::compile<logic::default_storage>(&xnor_function_multi);
